...
.search-box input{width:100%;padding:12px;border:none;
outline:none;font-size:16px}
.search-box button{padding:12px 20px;border:none;
...
.product{background:white;border-radius:12px;padding:18px;
...
.add-cart{width:100%;padding:12px;border:none;
border-radius:20px;background:#ffd814;cursor:pointer;
font-weight:bold}
#message{position:fixed;bottom:25px;right:25px;
background:#232f3e;color:white;padding:15px 22px;
border-radius:8px;font-weight:bold;opacity:0;
transition:.3s}
