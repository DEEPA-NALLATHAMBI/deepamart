...
.review-text{margin:5px 0;word-wrap:break-word}
.no-review{color:#777;font-size:14px}
#message{
 position:fixed;bottom:25px;right:25px;background:#232f3e;
 color:white;padding:15px 22px;border-radius:8px;font-weight:bold;
